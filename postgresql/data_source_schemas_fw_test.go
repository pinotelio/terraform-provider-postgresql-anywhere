...
func TestAccPostgresqlDataSourceSchemasFW(t *testing.T) {
	skipIfNotAcc(t)
	...
	config := generateDataSourceSchemasConfig(dbName)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.system_false_like_exp", "schemas.*", "test_exp"),
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.system_false_like_exp", "schemas.*", "exp_test"),
					...
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.system_false_like_pg_double_wildcard", "schemas.*", "test_pg"),
					resource.TestCheckResourceAttr("data.postgresql_schemas.system_true_like_information_schema", "schemas.#", "1"),
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.system_true_like_information_schema", "schemas.*", "information_schema"),
					resource.TestCheckResourceAttr("data.postgresql_schemas.like_test_schema", "schemas.#", "3"),
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.like_test_schema", "schemas.*", "test_schema"),
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.like_test_schema", "schemas.*", "test_schema1"),
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.like_test_schema", "schemas.*", "test_schema2"),
					...
					resource.TestCheckTypeSetElemAttr("data.postgresql_schemas.system_true_likeall_multi_not_like_multi_regex", "schemas.*", "test_exp"),
...
// generateDataSourceSchemasConfig builds the HCL config for the test.
