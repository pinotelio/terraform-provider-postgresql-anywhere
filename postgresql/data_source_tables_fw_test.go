...
func TestAccPostgresqlDataSourceTablesFW(t *testing.T) {
	skipIfNotAcc(t)
	...
	config := generateDataSourceTablesConfig(dbName)
...
// generateDataSourceTablesConfig builds the HCL config for the test.
