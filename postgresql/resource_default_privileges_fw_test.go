...
// dpCheckUserMembership checks whether `member` is (or is not) a member of `role`.
func dpCheckUserMembership(
...
func TestAccDefaultPrivilegesFW_Basic(t *testing.T) {
	skipIfNotAcc(t)
...
func TestAccDefaultPrivilegesFW_GrantOwner(t *testing.T) {
	skipIfNotAcc(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					dpCheckUserMembership(t, config.Username, "test_owner", false),
				),
			},
		},
	})
...
// Test the case where we define default privileges without specifying a schema.
func TestAccDefaultPrivilegesFW_NoSchema(t *testing.T) {
	skipIfNotAcc(t)
...
// Test default privileges on schemas (also asserts the multi-part id format).
func TestAccDefaultPrivilegesFW_OnSchemas(t *testing.T) {
	skipIfNotAcc(t)
...
func TestAccDefaultPrivilegesFW_Routines(t *testing.T) {
	skipIfNotAcc(t)
