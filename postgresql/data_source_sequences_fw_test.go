...
func TestAccPostgresqlDataSourceSequencesFW(t *testing.T) {
	skipIfNotAcc(t)
	...
	config := generateDataSourceSequencesConfig(dbName)
...
// generateDataSourceSequencesConfig builds the HCL config for the test.
